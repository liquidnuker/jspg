...
var _jspager = __webpack_require__(26);

var _jspager2 = _interopRequireDefault(_jspager);
...
// jspager1
// ======================================================/
var jspg = new _jspager2.default({
  data: items,
...
var jspg2 = new _jspager2.default({
  data: item2,
...
var jspg3 = new _jspager2.default({
  data: item3,
...
exports.default = JsPager;

var _pager = __webpack_require__(27);

var _pager2 = _interopRequireDefault(_pager);

var _pagebtns = __webpack_require__(28);
...
JsPager.prototype = {
  ...
  addEvents: function addEvents() {
    ...
    if (this.btn_first) {
      document.getElementById(this.btn_first).addEventListener("click", function () {
        _this.showItems(1);
      });
    }

    if (this.btn_last) {
      document.getElementById(this.btn_last).addEventListener("click", function () {
        _this.showItems(_this.pg.getTotalPages());
      });
    }
    ...
    document.getElementById(this.pageSelector).addEventListener("change", function (event) {
      _this.showItems(Number(event.target.value));
    });

    document.getElementById(this.perPageSelector).addEventListener("change", function (event) {
      _this.changePerPage(event.target.value);
    });

    if (this.pageJumpBtn && this.pageJumper) {
      document.getElementById(this.pageJumpBtn).addEventListener("click", function () {
        _this.pageJump();
      });

      document.getElementById(this.pageJumper).addEventListener("keypress", function (e) {
  ...
  showItems: function showItems(num) {
    ...
    var itemHolder = document.getElementById(this.itemHolder);
  ...
  pageJump: function pageJump() {
    var page = Number(document.getElementById(this.pageJumper).value);
    this.showItems(page);
  },
  ...
  setPageSelectorDropdown: function setPageSelectorDropdown(page) {
    var pageSelector = document.getElementById(this.pageSelector);
    pageSelector.innerHTML = "";

    var optsArr = [];
    for (var i = 0, l = this.pg.getTotalPages() + 1; i < l; i++) {
      optsArr.push({
        value: i,
        selected: false
      });
    ...
    for (var _i = 1, _l = this.pg.getTotalPages() + 1; _i < _l; _i++) {
      var el2 = document.createElement("option");
      el2.textContent = optsArr[_i].value;
      el2.value = optsArr[_i].value;
      el2.selected = optsArr[_i].selected;
      pageSelector.appendChild(el2);
    }
  },
  setPerPageDropdown: function setPerPageDropdown() {
    var perPageSelector = document.getElementById(this.perPageSelector);
  ...
  changePageBtns: function changePageBtns() {
    ...
    var pageBtnHolder = document.getElementById(this.pageBtnHolder);
    pageBtnHolder.innerHTML = "";

    var buttonSet = this.temp[this.pg.currentPage - 1];
    var el2 = void 0;
    buttonSet.forEach(function (i, index) {
      el2 = document.createElement("a");

      el2.className = _this2.pageBtnClass;
      el2.textContent = i;
      el2.value = i;
      el2.setAttribute("tabindex", 0);
      el2.setAttribute("aria-posinset", index + 1);

      if (el2.value === _this2.pg.currentPage) {
        el2.className += _this2.pageBtnActiveClass;
        el2.setAttribute("aria-selected", true);
      }

      el2.addEventListener("click", function (e) {
        _this2.showItems(e.target.value);
      });

      el2.addEventListener("keypress", function (e) {
        if (e.keyCode === 32 || e.keyCode === 13) {
          _this2.showItems(e.target.value);
        }
      });
